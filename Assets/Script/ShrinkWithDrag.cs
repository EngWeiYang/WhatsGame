...
public class ShrinkWithDrag : MonoBehaviour
{
    ...
    public float minHeight = 0.5f; // Minimum height scale (e.g., half of the original height)
    public float maxHeight = 1f;   // Maximum height scale (original height)
    public float lockThresholdY = 200f; // The maximum drag distance before it reaches minHeight
